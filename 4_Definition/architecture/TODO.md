...
- [x] Create the phase-owned `4_Definition/` project structure.
...
- [x] Create timestamped logs in `4_Definition/logs/`.
...
- [x] Copy `3_Validator/app_validator.db` to `4_Definition/app_designer.db` on
	the first run.
...
- [x] Document single-run and continuous-run commands in `4_Definition/README.md`.
