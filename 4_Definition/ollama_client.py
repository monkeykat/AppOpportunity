"""Small standard-library Ollama client used by Phase 4."""
...
try:
    from .config import DEFINITION_OLLAMA_TIMEOUT_SECONDS, OLLAMA_MODEL, OLLAMA_URL
except ImportError:
    from config import DEFINITION_OLLAMA_TIMEOUT_SECONDS, OLLAMA_MODEL, OLLAMA_URL
...
class OllamaClient:
    ...
    def generate_json(self, prompt: str, schema: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        with urlopen(request, timeout=DEFINITION_OLLAMA_TIMEOUT_SECONDS) as response:
