...
5_ArchitecturePOC/app_poc_architecture.db

into the Phase 6-owned database:

6_BuildPOC/app_builder.db
...
6_BuildPOC/builds/<poc_architecture_id>/
...
The generated project must remain inside its assigned `6_BuildPOC/builds/`
...
1. Copy and synchronize the Phase 5 database into `6_BuildPOC/app_builder.db`.
