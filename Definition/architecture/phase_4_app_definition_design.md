...
Phase 5 consumes the completed product design from `Definition/app_designer.db`.
...
Use timestamped logs in `Definition/logs/` and print meaningful progress before
