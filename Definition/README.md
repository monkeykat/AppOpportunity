...
Phase 4 copies `Validator/app_validator.db` to its private
`Definition/app_designer.db`. It preserves inherited Phase 2 and Phase 3 data
...
```bash
/home/gulfaero/Documents/Code/App\ Opportunity/Scout/.venv/bin/python Definition/design_product.py
```

Or from `Definition/`:

```bash
../Scout/.venv/bin/python design_product.py
```
...
```bash
/home/gulfaero/Documents/Code/App\ Opportunity/Scout/.venv/bin/python Definition/run_continuous.py --interval 30
```

Logs are written to `Definition/logs/` and mirrored to the terminal.

## Tests

```bash
/home/gulfaero/Documents/Code/App\ Opportunity/Scout/.venv/bin/python -m unittest discover -s Definition/tests -v
```
